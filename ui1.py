...
def analysis():
    ...
    for num, data in enumerate(verify_data):
        ...
        if str_label == 'bacterial':
            ...
            r = tk.Label(text='Click below for remedies...', background="lightgreen", fg="Brown", font=("", 15))
            r.grid(column=0, row=5, padx=10, pady=10)
            button3 = tk.Button(text="Remedies", command=eb)
            button3.grid(column=0, row=6, padx=10, pady=10)
...
def openphoto():
    ...
    fileName = askopenfilename(initialdir='C:\\Users\\K.Hari Varunavi\\Desktop\\A Promise\\Research Project\\PlantDiseaseDetection-master\\test\\test', title='Select image for analysis ',
                           filetypes=[('image files', '.jpg')])
    dst = "C:\\Users\\K.Hari Varunavi\\Desktop\\A Promise\\Research Project\\PlantDiseaseDetection-master\\testpicture"
